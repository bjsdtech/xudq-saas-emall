package com.xudq.emall.constant;
...
public class MDA {
     ...
     */
    public static final String CLIENT_SECRET = "xudq";

    /**
     * 认证服务器登陆地址
     */
    public static final String OAUTH_LOGIN_URL = "http://emall-authcenter/oauth/token";
