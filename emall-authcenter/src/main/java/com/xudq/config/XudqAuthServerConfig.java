...
import com.xudq.component.XudqTokenEnhancer;
import com.xudq.properties.JwtCAProperties;
...
public class XudqAuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Bean
    public XudqTokenEnhancer xudqTokenEnhancer() {
        return new XudqTokenEnhancer();
    }
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        tokenEnhancerChain.setTokenEnhancers(Arrays.asList(xudqTokenEnhancer(),jwtAccessTokenConverter()));

        endpoints.tokenStore(tokenStore()) //授权服务器颁发的token 怎么存储的
                .tokenEnhancer(tokenEnhancerChain)
                .userDetailsService(xudqUserDetailService) //用户来获取token的时候需要 进行账号密码
